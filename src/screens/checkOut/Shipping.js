...
const Shipping = (props) => {
    ...
    const [city, setCity] = useState(__DEV__ ? "ABC CITY" : '');
    const [address, setAddress] = useState(__DEV__ ? "ABC ADDRESS" : '');
    const [postalCode, setPostalCode] = useState(__DEV__ ? "ABC123" : '');
